...
export default function Header() {
  ...
  const determineActiveSection = useCallback(() => {
    ...
    const allSections = [...sections, "open-source", "education", "contact"]
  ...
  return (
    <header
      className={cn("sticky-header", scrolled ? "bg-background/80 backdrop-blur-md shadow-sm" : "bg-transparent")}
    >
